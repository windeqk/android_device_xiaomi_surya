...
void load_device_properties() {
    ...
    if (hwname == "surya") {
        set_device_props("POCO/surya_global/surya:11/RKQ1.200826.002/V12.0.1.0.RJGMIXM:user/release-keys",
                         "surya_global-user 11 RKQ1.200826.002 V12.0.1.0.RJGMIXM release-keys",
                         "surya", "POCO X3 NFC", "surya_global");
    } else if (hwname == "karna") {
        set_device_props("POCO/surya_in/surya:11/RKQ1.200826.002/V12.0.1.0.RJGINXM:user/release-keys",
